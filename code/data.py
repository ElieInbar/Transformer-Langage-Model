...
class CharTokenizer:
    ...
    def save(self, path: str) -> None:
        # On sauvegarde les données essentielles pour reconstruire le tokenizer
        # We save the essential data to reconstruct the tokenizer.
        # This includes the list of symbols, the set of tokens, the vocabulary list, and the stoi mapping.
        data_to_save = {
